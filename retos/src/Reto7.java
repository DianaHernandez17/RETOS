...
public class Reto7 {
        ...
        public static void  main(String[] args) {
         ...
         /* Programa que  le permita generar la simulación del juego piedra, papel o tijera con WHILE
         unicamente tiene 3 vidas para jugar, mostrar por pantalla si gana o pierde.*/
